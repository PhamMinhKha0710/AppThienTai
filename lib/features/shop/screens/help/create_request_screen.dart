import 'package:cuutrobaolu/features/shop/controllers/create_request_controller.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Obx(() => _buildAddressDropdown(
              ...
              onSearchChanged: (query) => controller.filterProvinces(query),
              onChanged: (value) => controller.selectProvince(value),
            )),
