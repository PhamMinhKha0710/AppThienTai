...
/// Loading skeleton for alert cards (reuse from victim)
class VolunteerAlertLoadingSkeleton extends StatelessWidget {
  const VolunteerAlertLoadingSkeleton({super.key});
